...
import { OursPrivacyPlatform, ClientOptions } from '@oursprivacy/platform-sdk';
...
function getTSDiagnostics(code: string): string[] {
  ...
  const codeWithImport = [
    ...
    functionSource.type === 'declaration' ?
      `async function run(${functionSource.client}: OursPrivacyPlatform)`
    : `const run: (${functionSource.client}: OursPrivacyPlatform) => Promise<unknown> =`,
    functionSource.code,
  ].join('\n');
...
const fuse = new Fuse(
  [
    ...
    'client.destinations.retrieve',
    'client.destinations.update',
    'client.sources.create',
    'client.sources.delete',
    'client.sources.list',
    'client.sources.retrieve',
    'client.sources.update',
    'client.allowedEvents.create',
    'client.allowedEvents.delete',
    'client.allowedEvents.list',
    'client.allowedEvents.retrieve',
    'client.consentSettings.create',
    'client.consentSettings.delete',
    'client.consentSettings.list',
    'client.consentSettings.retrieve',
    'client.consentSettings.update',
    'client.globalDispatchCenters.create',
    'client.globalDispatchCenters.delete',
    'client.globalDispatchCenters.list',
    'client.globalDispatchCenters.retrieve',
    'client.globalDispatchCenters.update',
    'client.replaySettings.create',
    'client.replaySettings.delete',
    'client.replaySettings.list',
    'client.replaySettings.retrieve',
    'client.replaySettings.update',
