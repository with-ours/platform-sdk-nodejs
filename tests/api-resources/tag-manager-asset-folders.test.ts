...
describe('resource tagManagerAssetFolders', () => {
  test('create: only required params', async () => {
    const responsePromise = client.tagManagerAssetFolders.create({
  ...
  test('create: required and optional params', async () => {
    const response = await client.tagManagerAssetFolders.create({
      assetId: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
      assetType: 'tagManagerTag',
      folderId: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
    });
